                ...
                <div>
                    <form action="#" method="POST">
                        <label for="about">
                            ...
                            <input v-model="event.about" autofocus
                                class="w-full rounded-lg focus:ring-primary focus:border-primary" type="text"
                                name="about" id="about" placeholder="Movies and cookies">
                        </label>
                        ...
                        <label v-if="eventTypeMeta.attendanceMode === 'inPerson'" for="location">
                            ...
                            <input v-model="event.location" autofocus
                                class="w-full rounded-lg focus:ring-primary focus:border-primary" type="text"
                                name="location" id="location" placeholder="Kicc grounds">
                        </label>

                        <label v-else for="location">
                            <h1>Add the event's url here</h1>
                            <input v-model="event.online_link" autofocus
                                class="w-full rounded-lg focus:ring-primary focus:border-primary" type="text"
                                name="location" id="location" placeholder="https://myonline-link.com">
                        </label>

                        <label for="desc">
                            <h1 class="mt-4">Add details about your event</h1>
                            <textarea v-model="event.description" placeholder="Give as much info as possible"
                                name="description" id="desc" class="w-full rounded-lg"></textarea>
                        </label>
                    </form>
                </div>
                    ...
                    <label for="poster">
                        <div @click="triggerPosterPicker"
                            ...
                            <div>
                                ...
                                <input @change="onPosterChange"
                                    class="w-full hidden rounded-lg focus:ring-primary focus:border-primary" type="file"
                                    accept="image/*" name="image" id="posterInput">
                            </div>
                        </div>
                    </label>
                </form>
            ...
            <div v-show="currentStep == 5">
                ...
                <div>
                    ...
                    <button @click="currentStep = 4"
                        class="flex w-fit mt-5 border border-gray-700 text-gray-700 rounded-lg px-4 py-3">
                        <svg xmlns="http://www.w3.org/2000/svg" class="mr-1 h-6 w-6" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M7 16l-4-4m0 0l4-4m-4 4h18" />
                        </svg>
