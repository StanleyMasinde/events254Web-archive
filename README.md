[![Netlify Status](https://api.netlify.com/api/v1/badges/8d7e59ae-b72f-47d4-8499-4df27f9d7f45/deploy-status)](https://app.netlify.com/sites/events254/deploys)
 ...
 *Please not that the api server does not have the `/api` prefix eg getting users is as simple as `/users` because `/users` will result in a 404 response*
...
> Route prefix `/events`. All these require auth
