...
const _93be93 = () => import('../handlers/renderer.mjs');

const handlers = [
  { route: '', handler: _33be66, lazy: true, method: undefined },
  { route: '/__nuxt_error', handler: _93be93, lazy: true, method: undefined },
  { route: '/**', handler: _93be93, lazy: true, method: undefined }
];
